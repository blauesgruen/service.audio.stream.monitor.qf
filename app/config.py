...
QF_REAPPEAR_BLOCK_SECONDS = 600.0
...
QF_VERIFIED_SOURCE_STREAM_FASTPATH_ENABLED = True
QF_VERIFIED_SOURCE_FEED_FASTPATH_MAX_SECONDS = 1.2
QF_VERIFIED_SOURCE_STREAM_FASTPATH_MIN_CONFIDENCE = 0.8
QF_VERIFIED_SOURCE_STREAM_FASTPATH_REQUIRE_CONFIRMED = True
QF_VERIFIED_SOURCE_FEED_CONFIDENCE = 0.98
QF_VERIFIED_SOURCE_STREAM_CONFIDENCE = 0.72
QF_VERIFIED_SOURCE_STREAM_CONFIRM_HITS = 2
QF_VERIFIED_SOURCE_STREAM_CONFIRM_WINDOW_SECONDS = 180.0
QF_VERIFIED_SOURCE_STREAM_SKIP_IF_FEED_PRESENT = True
QF_VERIFIED_SOURCE_SNAPSHOT_KEEPALIVE_ONLY = True
QF_PHASE_TIMING_PRECISION = 3
QF_RESULT_CACHE_ENABLED = True
QF_RESULT_CACHE_TTL_SECONDS = 12
QF_RESULT_CACHE_USE_ONLY_ON_VERIFIED_SOURCE_MISS = True
QF_VERIFIED_PROBE_MISS_RETURNS_NO_HIT = True
...
DISCOVERY_CRAWL_MAX_WORKERS = 4
DISCOVERY_PAGE_FETCH_BUDGET = 4
DISCOVERY_SCRIPT_FETCH_BUDGET = 6
DISCOVERY_OFFICIAL_PLAYER_ENTRY_LIMIT = 6
DISCOVERY_OFFICIAL_PLAYER_FOLLOWUP_BUDGET = 8
DISCOVERY_PLAYERBAR_MAX_CONTAINERS = 24
DISCOVERY_PLAYERBAR_MAX_WORKERS = 4
DISCOVERY_CTRL_API_FUTURE_GRACE_SECONDS = 5.0
DISCOVERY_CTRL_API_START_DELAY_SECONDS = 15.0
...
NOWPLAYING_PARALLEL_PROBING_ENABLED = True
NOWPLAYING_PARALLEL_MAX_WORKERS = 4
NOWPLAYING_PARALLEL_BATCH_SIZE = 4
